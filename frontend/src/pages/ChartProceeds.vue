    ...
    <el-row :gutter="20">
        <el-col :span="24">
            <el-card style="margin-bottom: 10px">
                <div slot="header">
                    <span style="font-size: 120%;">日收款金额曲线</span>
                    <el-date-picker v-model="date1" type="month" placeholder="选择月" size="mini" style="float: right; width: 120px"></el-date-picker>
                </div>
                <charts-builder content="proceedsDay" :date="date01" type="line"></charts-builder>
            </el-card>
        </el-col>
        <el-col :span="24">
            <el-card  style="margin-bottom: 10px">
                <div slot="header">
                    <span style="font-size: 120%;">月收款金额统计</span>
                    <el-date-picker v-model="date2" type="year" placeholder="选择年" size="mini" style="float: right; width: 120px"></el-date-picker>
                </div>
                <charts-builder content="proceedsMonth" :date="date02" type="histogram"></charts-builder>
            </el-card>
        </el-col>
    </el-row>
</template>
